  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="relative group">
        <div className="absolute -inset-1 rounded-3xl blur-xl opacity-0 group-hover:opacity-70 transition duration-500 bg-gradient-to-r from-[#c8b8b1] via-[#d7a77a] to-[#b58363]"></div>

        <div className="relative bg-[#f9f7f5] rounded-3xl shadow-xl p-4 sm:p-8 transition-all duration-300 group-hover:shadow-[#c8b8b1]/40">
